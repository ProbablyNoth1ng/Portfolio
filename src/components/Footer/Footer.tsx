            ...
            <footer className="footer pt-20 pb-5" id='footer'>
                <div className="container mx-auto">
                    ...
                    <div className="flex justify-center pt-10"> 
                        <div className='mx-10'><a href="https://www.linkedin.com/in/andriikaplan"><i className="fa-brands fa-linkedin  text-2xl text-white"></i></a></div>
                        <div className='mx-10'><a href="https://github.com/ProbablyNoth1ng"><i className="fa-brands fa-github  text-2xl text-white"></i></a></div>
                    </div>
                </div>
