        ...
        <>
            <footer className="footer pt-20 pb-5" id='footer'>
                <div className="container mx-auto">
                    ...
                    <div className='flex justify-center'><a href="mailto:andrii.kaplan.work@gmail.com" className='cursor-pointer footer_btn text-white uppercase text-2xl font-bold'>Send an email </a></div>
